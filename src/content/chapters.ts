...
import { verheorLenaBergmannChapter } from "./verheor-lena-bergmann";
...
import { USBStickAnalyseChapter } from "./usb-stick-analyse";
import { USBStickAnalysePathAChapter } from "./usb-stick-analyse-a";
import { USBStickAnalysePathBChapter } from "./usb-stick-analyse-b";
import { waffenboxPruefenChapter } from "./waffenbox-pruefen";
import { untersuchungDesAlibisChapter } from "./untersuchung-des-alibis";
import { zeugenbefragungChapter } from "./zeugenbefragung";
import { konfrontationLenaBergmannChapter } from "./konfrontation-lena-bergmann";
import { videoPruefenChapter } from "./video-pruefen";
import { finaleEntscheidungChapter } from "./finale-entscheidung";
import { festnahmeChapter } from "./festnahme";
import { finalePetraHaasChapter } from "./finale-petra-haas";
...
export const chapters: Chapter[] = [
  ...
  USBStickAnalyseChapter,
  USBStickAnalysePathAChapter,
  USBStickAnalysePathBChapter,
  waffenboxPruefenChapter,
  verheorLenaBergmannChapter,
  untersuchungDesAlibisChapter,
  zeugenbefragungChapter,
  konfrontationLenaBergmannChapter,
  videoPruefenChapter,
  finaleEntscheidungChapter,
  festnahmeChapter,
  finalePetraHaasChapter,
